...
mlServiceRepos=("mlService_mlServiceApi" "mlService_dockerApi" "mlService_dataPreprocessing" "mlService_frontend" "mlService_atlas" "mlService_data-service_fhirOmop")
baseDir=$(pwd)
